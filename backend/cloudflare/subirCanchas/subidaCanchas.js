...
const R2 = new S3Client({
  ...
  credentials: {
    accessKeyId: process.env.ID_Subida_Canchas, // Reemplaza por tu Access Key
    secretAccessKey: process.env.Clave_Subida_Canchas, // Reemplaza por tu Secret Key
  },
});

const BUCKET = process.env.BUCKET_Subida_Canchas; // Corregido: usar el bucket de canchas, no el de perfil
