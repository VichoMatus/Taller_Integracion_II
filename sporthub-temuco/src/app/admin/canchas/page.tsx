...
export default function CanchasPage() {
  ...
  const courts: Court[] = [
    ...
    { id: '2', name: 'Cancha Central', location: 'Av. Principal 123', status: 'Inactivo', lastAccess: '28-08-2025' },
    { id: '3', name: 'Cancha Central', location: 'Av. Principal 123', status: 'Por revisar', lastAccess: 'Ayer, 16:45' },
    { id: '4', name: 'Cancha Central', location: 'Av. Principal 123', status: 'Activo', lastAccess: 'Hoy, 11:35' },
    { id: '5', name: 'Cancha Norte', location: 'Av. Norte 456', status: 'Activo', lastAccess: 'Hoy, 08:20' },
    { id: '6', name: 'Cancha Sur', location: 'Av. Sur 789', status: 'Inactivo', lastAccess: '25-08-2025' },
  ];
            ...
            <tbody>
              {paginatedCourts.map((court) => (
                <tr key={court.id}>
                  ...
                  <td>
                    <div className="admin-cell-text">{court.lastAccess}</div>
                  </td>
                  <td>
