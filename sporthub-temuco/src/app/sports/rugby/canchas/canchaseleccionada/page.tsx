...
export default function CanchaSeleccionadaPage() {
  ...
  // 🔥 DATOS ESTÁTICOS - Adaptados para rugby
  const cancha = {
    id: 1,
    ...
    description: "Campo de rugby con superficie profesional, áreas de entrenamiento y vestuarios completos.",
    schedule: "Lunes a Domingo • 08:00 a 20:00",
    ...
    amenities: ["Estacionamientos", "Vestuarios Completos", "Campo Profesional", "Iluminación LED", "Área de Entrenamiento"],
    reviewsList: [
      {
        name: "María P.",
        rating: 5,
      ...
      },
      {
        ...
        rating: 5,
        date: "hace 2 semanas",
        comment: "El campo está en excelentes condiciones, ideal para partidos de rugby."
      }
    ]
  };
      ...
      <div className={styles.mainContent}>
        ...
        <div className={styles.header}>
          <div className={styles.headerLeft}>
            ...
            <h1 className={styles.headerTitle}>Rugby - {cancha.name}</h1>
          </div>
