...
export default function CanchaSeleccionadaPage() {
  ...
  // 🔥 DATOS ESTÁTICOS DE TENIS - Adaptado completamente
  const cancha = {
    id: 1,
    name: "Tenis Elite Center",
    location: "Av. Alemania 1234, Temuco, Chile",
    coordinates: { lat: -38.7359, lng: -72.5904 },
    phone: "(45) 555-1234",
    instagram: "@teniselitecenter",
    description: "Cancha de tenis profesional con superficie de arcilla templada, sistema de drenaje premium y sistema de iluminación LED de última generación. Incluye raquetas y pelotas profesionales.",
    ...
    amenities: ["Superficie Arcilla", "Iluminación Premium", "Raquetas Profesionales", "Vestuarios VIP", "Sistema Drenaje"],
    reviewsList: [
      {
        name: "Carlos M.",
        rating: 5,
        date: "hace 2 días",
        comment: "Excelente cancha de tenis! La superficie de arcilla está perfectamente mantenida y las raquetas profesionales son de primera calidad."
      },
      {
        name: "Ana R.",
        rating: 5,
        date: "hace 5 días", 
        comment: "La mejor cancha de tenis de Temuco. Iluminación perfecta para jugar de noche y el personal muy profesional. Totalmente recomendada."
      },
      {
        name: "Roberto L.",
        rating: 4,
        date: "hace 1 semana",
        comment: "Muy buena experiencia jugando tenis. La cancha está en perfecto estado y los vestuarios son de lujo. Volveremos pronto."
      }
    ]
  };
  ...
  const handleHelp = () => {
    alert('¿Necesitas ayuda con tenis? Contáctanos al (45) 555-0000 o envía un email a tenis@sporthub.cl');
  };
      ...
      <div className={styles.mainContent}>
        ...
        <div className={styles.courtInfoCard}>
          <div className={styles.courtHeader}>
            <h2 className={styles.courtTitle}>{cancha.name} - Cancha Tenis</h2>
          ...
          <div className={styles.descriptionSection}>
            <h3 className={styles.sectionTitle}>
              <span>🏟️</span>
              Descripción de la Cancha de Tenis
            </h3>
          ...
          <div className={styles.imagesSection}>
            ...
            <div className={styles.imageCarousel}>
              ...
              <div className={styles.imageContainer}>
                <Image 
                  src={cancha.images[currentImageIndex] || "/sports/tenis/canchas/Cancha1.png"} 
                  alt={`${cancha.name} - Cancha de Tenis - Imagen ${currentImageIndex + 1}`}
          ...
          <div className={styles.contactCard}>
            <div className={styles.contactInfo}>
              ...
              <div className={styles.contactItem}>
                ...
                <span className={styles.contactValue}>Tenis Profesional</span>
              </div>
            </div>
