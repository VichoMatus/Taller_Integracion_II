...
export default function EditarPerfil() {
  const [formData, setFormData] = useState({
    ...
    sport: undefined as SportType, // ✅ Cambiado a undefined
    age: "28",
  ...
  const handleChange = (e: React.ChangeEvent<HTMLInputElement | HTMLTextAreaElement | HTMLSelectElement>) => {
    ...
    setFormData({
      ...formData,
      [name]: name === 'sport' ? (value === '' ? undefined : value as SportType) : value
    });
  };
  ...
  return (
    <UserLayout userName={formData.name} notificationCount={2}> {/* ✅ Quitado sport={formData.sport} */}
